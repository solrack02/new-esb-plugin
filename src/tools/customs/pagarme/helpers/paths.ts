export const cardNumPath = 'sc.B4.currData.orderData.payments.0'; // Só Numero Cartão vai pra esse caminho
...
export const txtErrorDefault1 = 'Verifique todos os campos obrigatórios.';
